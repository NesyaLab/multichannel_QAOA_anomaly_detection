...
- `AD_QAOA_ext.py`: core implementation of the QAOA-based anomaly detection pipeline.
- `AD_QAOA_multicover.py`: utilities for multichannel detection and covering strategies.
- `functions/`: supporting utility functions used by the main pipeline.
- `execute_ext.ipynb` and `execute_final_mqad.ipynb`: notebooks to run and reproduce the main workflow.
- `main.pdf`: the reference paper associated with this repository. :contentReference[oaicite:1]{index=1}
